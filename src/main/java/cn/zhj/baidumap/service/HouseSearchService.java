...
import cn.zhj.baidumap.pojo.BusinessCircle;
import cn.zhj.baidumap.pojo.Community;
import cn.zhj.baidumap.pojo.District;
import cn.zhj.baidumap.pojo.House;
...
public class HouseSearchService {
    ...
    public List<HouseResultVo> search(Double maxLongitude,
        ...
        groupOperation = groupOperation.count().as("total").avg("price").as("price");
